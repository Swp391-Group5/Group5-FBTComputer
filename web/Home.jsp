                                    ...
                                    <c:forEach var="o" items="${listP}">
                                        <div class="col-12 col-md-6 col-lg-4">
                                            <div class="card mb-3">
                                                ...
                                                <div class="card-body">
                                                    <h4 class="card-title">
                                                        <a href="detail?productId=${o.productId}" title="View Product" class="text-decoration-none text-black">${o.productName}</a>
                                                    </h4>
                                                            ...
                                                            <div class="col">
                                                                <div class="text-center">
                                                                    ...
                                                                    <c:choose>
                                                                        ...
                                                                        <c:otherwise>
                                                                            <!-- Add to Cart button -->
                                                                            <p class="btn w-100 ms-2">
                                                                                <a href="cartprocess?productId=${o.productId}" class="btn btn-danger">
                        ...
                        <div class="col-sm-12">
                            <div id="content" class="row">
                                <div class=" col-12 col-md-12 col-lg-6">
                                    <div class="card-body">
                                        <h4 class="card-title show_txt text-black" style="text-align:center;
                                        font-size:18pt;">About Shop</h4>
                                    <h2 class="card-title show_txt" style="text-align:center;
                                        font-size:24pt;">FBT Computer</h2>
                                    ...
                                    <p>Are you in need of a stylish and trendy laptop from top brands but don't have enough budget to afford the genuine ones? Look no further than FBT Computer – where you can fulfill your desires without breaking the bank. With just a fraction of the cost compared to the authentic ones sold in stores, you can still get yourself a quality laptop ranging from 1:1 replicas to super high-end ones..</p>                  
                                </div>  
                            </div>
                            <div class=" col-12 col-md-12 col-lg-6">

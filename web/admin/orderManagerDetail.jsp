    ...
    <body>
        ...
        <div class="container">
            ...
            <p style="text-align: right">
                ...
                <a href="#">Print</a> |
                <a href="${pageContext.request.contextPath}/OrderPDFServlet?orderId=${order.orderId}&action=PDF&payment=${requestScope.paymentMethod}" target="_blank">PDF</a> |
                <a href="${pageContext.request.contextPath}/OrderPDFServlet?orderId=${order.orderId}&action=Email&payment=${requestScope.paymentMethod}">Email</a>
            </p>
            <br>
            <br>

<%-- 
    Document   : slider
    Created on : Jun 13, 2024, 3:35:42 PM
    Author     : Admin
--%>
...
<!--            <nav class="navbar navbar-expand-lg navbar-light bg-primary">
            ...
            <div id="layoutSidenav">
                ...
                <div class="groundy" id="layoutSidenav_content">
                    <h1 class="text-center">Slider Manager</h1>

                    <div class="container">
                        <div class="search-toggle">
                            <!--                            <input type="checkbox" id="searchToggle" class="toggle-input">
                                                        <label for="searchToggle" class="toggle-label">Toggle Search</label>-->
                            <button class="mb-2 text-center btn btn-primary"><a style="text-decoration: none" class="text-white" href="add-slider">Add Slider</a></button>

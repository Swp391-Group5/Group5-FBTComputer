...
<html class="no-js" lang="zxx"> <!--<![endif]-->
    <head>
        ...
        <script>
            function changePage() {
                var index = document.getElementById("pageSelect").value;
                var search = document.getElementById("search").value;
                window.location.href = "ListBlog?index=" + index + "&search=" + search;
            }
        </script>
    </head>
    <body>
                                                ...
                                                <c:forEach var="blog" items="${blogs}">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <article class="tg-post">
                                                            <figure><a href="blogs?action=view&id=${blog.blogid}"><img src="${blog.blogthumnail}" alt="image description"></a></figure>
                                            ...
                                            <div class="tg-widgetcontent">
                                                <ul>
                                                    <c:forEach var="o" items="${top3}">
                                                        <li>
                                                            <article class="tg-post">
                                                                <figure><a href="blogs?action=view&id=${o.blogid}"><img src="${o.blogthumnail}" alt="image description"></a></figure>
                                                                <div class="tg-postcontent">
                                                                    <div class="tg-posttitle">
                                                                        <h3><a href="blogs?action=view&id=${o.blogid}">${o.blogtitle}</a></h3>
                                                                    </div>
                                                                    <span class="tg-bookwriter"> <a href="javascript:void(0);">${o.blogdate}</a></span>
                                                                </div>
                                                            </article>
                                                        </li>
                                                    </c:forEach>

                    ...
                    <div class="row g-5">
                        <div class="col-md-12 col-lg-6 col-xl-7">
                            <div class="form-item">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Full name" value="${sessionScope.customer.customerName}" required="" readonly="">
                            </div>        
                            ...
                            <div class="form-item">
                                ...
                                <input type="tel" class="form-control" name="phone" placeholder="Phone number" value="${sessionScope.customer.customerPhoneNumber}" required="">
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center mt-2">
                                                        <img src="${c.productImage}" class="img-fluid rounded-circle" style="width: 90px; height: 90px;" alt="">
                                                    </div>
                                                </th>
                                                <td class="py-5 text-center align-middle">${c.productName}</td>
                                                <td class="py-5 text-center align-middle"><fmt:formatNumber value="${c.productPrice}" type="currency" currencySymbol="VND"/></td>
                                                <td class="py-5 text-center align-middle">${c.numberInCart}</td>
                                                <td class="py-5 text-center align-middle"><fmt:formatNumber value="${c.productPrice * c.numberInCart}" type="currency" currencySymbol="VND"/></td>
                                            </tr>
                                        </c:forEach>
                                        <tr>
                                            <th scope="row">

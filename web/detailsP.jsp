                ...
                <div class="single_product">
                                ...
                                <c:forEach var="similarProduct" items="${similarProducts}">
                                    <div class="col-md-4">
                                        <div class="card mb-3 similar_product">
                                            <a style="text-decoration: none" href="detail?productId=${similarProduct.getProductId()}" >   <img  src="UPLOAD_IMAGE1/${similarProduct.getProductImage()}" class="card-img-top" alt="${similarProduct.getProductName()}"></a>
                                                <div class="card-body">
                                                    <h5 class="card-title">
                                    ...
                                    <c:forEach var="viewedProduct" items="${viewedProductDetails}">
                                        <div class="col-md-4">
                                            <div class="card mb-3 similar_product">
                                                <div class="row g-0">
                                                    <div class="col-md-6">
                                                        <a class="text-black" style="text-decoration: none" href="detail?productId=${viewedProduct.productId}">
                    ...
                    <div class="container">
                        <div id="reviews" class="review-section">
                            <div class="mb-4">
                                <c:if test="${requestScope.totalFeedback > 0}">
                                    <h4 class="m-0">Showing ${requestScope.totalFeedback} feedback with ${requestScope.sumStar} <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1792 1792" width="15" height="15">
                                                                <path
                                                                    fill="currentColor"

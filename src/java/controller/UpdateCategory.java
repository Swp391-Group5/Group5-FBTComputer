 ...
 * @author admin
 */
@WebServlet(name = "UpdateCategory", urlPatterns = {"/update-cate"})
public class UpdateCategory extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       String id_raw = request.getParameter("cid");
        ...
        String status_raw = request.getParameter("cstatus");
        try {
            int categoryId = Integer.parseInt(id_raw);
           int  categoryStatus = Integer.parseInt(status_raw);
            
              Category c = new Category(categoryId, name, categoryStatus);
            ...
            // Redirect to the servlet handling listing of categories
